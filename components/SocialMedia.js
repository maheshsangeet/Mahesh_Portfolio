  ...
  return (
    <section className={styles.socialMedia}>
      <div className={styles.socialMediaContainer}>
          ...
          <div className={styles.media} >
            ...
            <div className={`${styles.iconContainer} ${styles.div4}`}> 
              <Link href="tel:8660804309">
                <a target="_blank" rel="noopener noreferrer" style={{background: "rgb(12, 152, 103)"}}>
        ...
        <div className={styles.cornerSocialMedia} style={{ color: "rgb(25, 45, 56)", position: "absolute", bottom: "0px", right: "0px",display:`${hideButton}`}} onClick={SocialMedia}>
          <svg data-v-553b04e0="" width="80" height="80" viewBox="0 0 250 250" aria-hidden="true" style={{ fill: "rgb(30, 218, 255)", position: "absolute", bottom: "0px", border: "0px", right: "0px", zIndex:"10" }}>
